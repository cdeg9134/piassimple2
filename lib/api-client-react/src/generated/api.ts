...
export const deleteTicket = async (
  id: number,
  deleteTicketBody: DeleteTicketBody,
  options?: RequestInit,
): Promise<void> => {
  return customFetch<void>(getDeleteTicketUrl(id), {
    ...
    method: "DELETE",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(deleteTicketBody),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: number; data: BodyType<DeleteTicketBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return deleteTicket(id, data, requestOptions);
  };
...
export type DeleteTicketMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteTicket>>
>;
export type DeleteTicketMutationBody = BodyType<DeleteTicketBody>;
...
export const unlockTicket = async (
  ...
  options?: RequestInit,
): Promise<UnlockTicket200> => {
  return customFetch<UnlockTicket200>(getUnlockTicketUrl(id), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export type UnlockTicketMutationError = ErrorType<void>;
